...
CREATE TABLE `profil` (
  `ID_PROFILU` varchar(45) NOT NULL,
...
INSERT INTO `profil` VALUES ('PRO_B','PROFIL BIOLOGICZNO-CHEMICZNO-GEOGRAFICZNY'),('PRO_H','PPROFIL HUMANISTYCZNO-WOSOWO-HISTORYCZNY'),('PRO_M','PROFIL MATEMATYCZNO-FIZYCZNO-INFORMATYCZNY');
